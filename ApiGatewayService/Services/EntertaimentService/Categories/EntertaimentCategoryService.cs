...
{
    public class EntertaimentCategoryService(ILogger<EntertaimentCategoryService> logger, KafkaRequestService kafkaRequestService) : IEntertaimentCategoryService
    {
        private readonly ILogger<EntertaimentCategoryService> _logger = logger;
        private readonly KafkaRequestService _kafkaRequestService = kafkaRequestService;
        private readonly string requestTopic = Environment.GetEnvironmentVariable("ENTERTAIMENT_CATEGORY_REQUEST_TOPIC");
        private readonly string responseTopic = Environment.GetEnvironmentVariable("ENTERTAIMENT_CATEGORY_RESPONSE_TOPIC");
